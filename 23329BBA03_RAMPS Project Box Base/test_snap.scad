...
standoff_screw_thread_exposed_length = 5.8;
...
// The Following will be used as the first element in the pbc array
//Defined here so you can define the "Main" PCB using these if wanted
pcbLength           = 20; // front to back (X axis), all 3 boards
pcbWidth            = 10; // side to side (Y axis), all 3 boards
pcbThickness        = 1; // all 3 boards
...
//   Required:
//    p(0) = posx | posy
//    p(1) = width | [width, sides] | [width, sides, rotation] 
//           default sides=$fn, default rotation = 0
...
snapJoins   =   
[
//    [shellLength*2/8-snap_w/2, [snap_w, 4, 45], yappLeft],
//    [shellLength*2/8-snap_w/2, [snap_w, 6, 30], yappRight],
//    [shellLength*6/8-snap_w/2, [snap_w, 8, 22.5], yappLeft],
    [shellLength*6/8-snap_w/2, snap_w, yappRight, yappLeft, yappSymmetric],
//    [shellLength*6/8-snap_w/2, snap_w, yappLeft, yappRight],
];
