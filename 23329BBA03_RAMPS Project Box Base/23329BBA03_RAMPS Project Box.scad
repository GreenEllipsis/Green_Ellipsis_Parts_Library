...
//RAMPS
//Arduno MEGA 2560 holes, offset from corner with power connector
hole_top_left=[14+1.3, 2.5+5.1+27.9+15.2];
hole_top_right=[hole_top_left.x+50.8+24.1, hole_top_left.y];
hole_top_center=[hole_top_left.x+50.8, 2.5+5.1+27.9];
...
// The Following will be used as the first element in the pbc array
//Defined here so you can define the "Main" PCB using these if wanted
pcbLength           = 100.44+9.77; // front to back (X axis), all 3 boards
pcbWidth            = 62.26; // side to side (Y axis), all 3 boards
pcbThickness        = 41.80; // all 3 boards
standoffHeight      = standoff_screw_thread_exposed_length-top_bottom_thickness; //-- How much the PCB needs to be raised from the base 
...
baseWallHeight      = 23;
lidWallHeight       = pcbThickness-baseWallHeight+paddingRight*2+standoffHeight;
...
showSideBySide            = $preview ? true : true;       //-> Default = true
...
inspectX                  = $preview ? 0 : 0;          //-> 0=none (>0 from Back)
...
[
  [
  hole_top_right.x+mega_offset.x,
  hole_top_right.y+mega_offset.y,
  yappDefault, yappDefault, yappDefault, yappBaseOnly,yappHole, yappNoFillet
  ],
  [
  hole_top_left.x+mega_offset.x,
  hole_top_left.y+mega_offset.y,
yappBaseOnly,yappHole, yappNoFillet
  ],  [
  hole_top_center.x+mega_offset.x,
  hole_top_center.y+mega_offset.y,
  yappDefault, yappDefault, 7, yappBaseOnly,yappHole, yappNoFillet
  ],  [
  hole_bottom_center.x+mega_offset.x,
  hole_bottom_center.y+mega_offset.y,
  yappDefault, yappDefault, 7, yappBaseOnly,yappHole, yappNoFillet
  ],  [
  hole_bottom_right.x+mega_offset.x,
  hole_bottom_right.y+mega_offset.y,
  yappDefault, yappDefault, 6, yappBaseOnly,yappHole, yappNoFillet
  ],  [
  hole_bottom_left.x+mega_offset.x,
  hole_bottom_left.y+mega_offset.y,
  yappDefault, yappDefault, 7, yappBaseOnly,yappHole, yappNoFillet
  ],
];
//echo(pcbLength=pcbLength);
//echo(mega_offset=mega_offset);
//pcbStands=[mega_offset];
...
[
  [
    hole_top_left.x+mega_offset.x-hole_d/2,
    hole_top_left.y+mega_offset.y-hole_d/2,
    yappDefault, yappDefault, hole_d/2, yappCircle, yappCoordPCB],
  [
    hole_top_right.x+mega_offset.x-hole_d/2,
    hole_top_right.y+mega_offset.y-hole_d/2,
    yappDefault, yappDefault, hole_d/2, yappCircle, yappCoordPCB],
  [
    hole_top_center.x+mega_offset.x-hole_d/2,
    hole_top_center.y+mega_offset.y-hole_d/2,
    yappDefault, yappDefault, hole_d/2, yappCircle, yappCoordPCB],
  [
    hole_bottom_center.x+mega_offset.x-hole_d/2,
    hole_bottom_center.y+mega_offset.y-hole_d/2,
    yappDefault, yappDefault, hole_d/2, yappCircle, yappCoordPCB],
  [
    hole_bottom_left.x+mega_offset.x-hole_d/2,
    hole_bottom_left.y+mega_offset.y-hole_d/2,
    yappDefault, yappDefault, hole_d/2, yappCircle, yappCoordPCB],
  [
    hole_bottom_right.x+mega_offset.x-hole_d/2,
    hole_bottom_right.y+mega_offset.y-hole_d/2,
    yappDefault, yappDefault, hole_d/2, yappCircle, yappCoordPCB],
];
...
$preview ? [] 
: [
  [7, 7, shellLength-7*2, shellWidth-7*2,yappDefault, yappRectangle, maskHoneycomb, yappCoordBox]
];

cutoutsFront =  
[ // from left, from bottom
// ribbon cables cutout
[12.85, 13, 42.51, 7, 2, yappRoundedRect]
];
...
// USB cutoutf
[38.1, 0, 16.05, 12.3, yappDefault, yappRectangle],
// barrel plug cutout
[11.2, 0, 10.95+2.5, 12.3, yappDefault, yappRectangle],
// D8,9,10 terminal cutout
[23.46-0.5, 14.71-0.5-2, 31.23, 5.6+0.5+2, yappDefault, yappRectangle],
// power terminal cutout
[2.28-0.5, 14.71-0.5-2, 20.31+1, 17+1, yappDefault, yappRectangle],
];

cutoutsLeft =   
$preview ? [ // from back, from bottom, width, height
  // reset button cutout
  [34.0-4.24, 13.05+3, yappDefault, yappDefault, 3, yappCircle],
] 
:
[
  // reset button cutout
  [38.0, 13.05+3, yappDefault, yappDefault, 3, yappCircle],
  [9, basePlaneThickness+2, shellLength-9*2, baseWallHeight - ridgeHeight-4, yappDefault, yappRectangle, maskHoneycomb, yappCoordBox],
];
...
boxMounts =
[
[[shellLength/2-55, 0], 4.4, 0, 5, yappLeft, yappRight],
[[shellLength/2+55, 0], 4.4, 0, 5, yappLeft, yappRight],
// these two a kludge to widen the foot to keep it out of the v-slot
[[shellLength/2-55-2.1, 0], 4.3, 4.2, 5, yappLeft, yappRight],
[[shellLength/2+55-2.1, 0], 4.3, 4.2, 5, yappLeft, yappRight]
];
//===================================================================
//  *** Light Tubes ***
...
labelsPlane =
[
  [5, shellHeight-10, 0, 1, yappRight, "Corbel:style=Bold", 6, "23329BBA04"],
  [25, 5, 0, 1, yappBase, "Corbel:style=Bold", 6, "23329BBA03"],
];
...
//:
[
  [ shellWidth/2-9, 27, 0, 0.5, yappFront, "24008BBA00_Autotrude Logo15x15.svg", 1.25 ]
];
//===================================================================
//  *** Ridge Extension ***
...
//translate([107.95+wallThickness+paddingBack-5,61.21+wallThickness+paddingLeft,4]) rotate(180) import("RepRap.stl");
