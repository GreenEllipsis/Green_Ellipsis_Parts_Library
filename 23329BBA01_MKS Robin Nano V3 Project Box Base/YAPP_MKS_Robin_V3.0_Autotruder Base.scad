...
function baseMounts() = baseMounts;

function basePlaneThickness() = basePlaneThickness;
...
function paddingBack() = paddingBack;
function paddingFront() = paddingFront;
function paddingLeft() = paddingLeft;
function paddingRight() = paddingRight;

function pcbStands() = pcbStands;

function standoffHeight() =standoffHeight;

function wallThickness() = wallThickness;
